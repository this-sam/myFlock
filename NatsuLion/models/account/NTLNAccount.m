...
- (NSString *)ril_username {
	return [[NSUserDefaults standardUserDefaults] stringForKey:TWT_PREFERENCE_RIL_USERID];
}

- (NSString *)ril_password {
	return [[NSUserDefaults standardUserDefaults] stringForKey:TWT_PREFERENCE_RIL_PASSWORD];
}
