//
//  TWTRILAccountViewController.m
//  tweetee
//
//  Created by fizban on 3/21/10.
...
@interface TWTRILAccountViewController(Private)
...
@implementation TWTRILAccountViewController
...
- (id)initWithStyle:(UITableViewStyle)style {
	if (self = [super initWithStyle:style]) {
		[self.navigationItem setTitle:@"Read It Later Account"];
	}
	return self;
}
