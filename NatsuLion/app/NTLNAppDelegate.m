...
- (void)createViews {
	...
	trendsViewController = [[TWTTrendsViewController alloc] init];
	
	searchViewController = [[TWTSearchViewController alloc] initWithStyle:UITableViewStyleGrouped];
	...
	UINavigationController *ttrn = [[[UINavigationController alloc]
									 initWithRootViewController:trendsViewController] autorelease];
	
	UINavigationController *srcvc = [[[UINavigationController alloc]
	...
	[ttrn.navigationBar setBarStyle:UIBarStyleBlackOpaque];
	[ttrn.tabBarItem setTitle:@"Trends"];
	[ttrn.tabBarItem setImage:[UIImage imageNamed:@"trends.png"]];
	
	[srcvc.navigationBar setBarStyle:UIBarStyleBlackOpaque];
	[srcvc.tabBarItem setTitle:@"Search"];
	[srcvc.tabBarItem setImage:[UIImage imageNamed:@"search.png"]];

	[lvctrl.navigationBar setBarStyle:UIBarStyleBlackOpaque];
	[lvctrl.tabBarItem setTitle:@"Lists"];
	[lvctrl.tabBarItem setImage:[UIImage imageNamed:@"lists.png"]];
...
- (void)presentTwitterExtendedAccountSettingView {
	UITableViewController *vc = [[[TWTTwitterExtendedAccountViewController alloc] 
								  initWithStyle:UITableViewStyleGrouped] autorelease];
	UINavigationController *nc = [[[UINavigationController alloc] 
								   initWithRootViewController:vc] autorelease];
	[nc.navigationBar setBarStyle:UIBarStyleBlackOpaque];
